...
public class DrawerAdapter extends
	...
	public static class ViewHolder extends RecyclerView.ViewHolder {
		...
		public ViewHolder(View itemView, int ViewType) { // Creating ViewHolder
			...
			if (ViewType == TYPE_ITEM) {
				relRow = (LinearLayout) itemView.findViewById(R.id.relRow);
	...
	public DrawerAdapter(Context context, String Titles[], int Icons[], String Name,
			String Email, int Profile) { // MyAdapter Constructor with titles
											// and icons
											// parameter
	...
	public void onBindViewHolder(ViewHolder holder, int position) {
		if (holder.Holderid == 1) { // as the list view is going to be called
			...
			holder.relRow.setTag(position);
			holder.relRow.setOnClickListener((OnClickListener) mContext);
		} else {
